...
uses
  Windows, BTMemoryModule, Classes;
...
procedure LoadRarLibrary(hInst:Cardinal);
...
Begin
  ...
  try
    ...
    @RAROpenArchiveEx      := BTMemoryGetProcAddress(mp_MemoryModule,'RAROpenArchiveEx');
    ...
    @RARReadHeaderEx       := BTMemoryGetProcAddress(mp_MemoryModule,'RARReadHeaderEx');
    @RARProcessFile        := BTMemoryGetProcAddress(mp_MemoryModule,'RARProcessFile');
    @RARSetCallback        := BTMemoryGetProcAddress(mp_MemoryModule,'RARSetCallback');
    ...
    @RARGetDllVersion      := BTMemoryGetProcAddress(mp_MemoryModule,'RARGetDllVersion');
  finally
  end;
end;
