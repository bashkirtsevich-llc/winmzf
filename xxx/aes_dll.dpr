...
(*************************************************************************
 ...
 REQUIREMENTS    :  D2-D7/D9-D10, compile with $define DLL
...
{---------------------------------------------------------------------------}
function AES_DLL_Version: PChar; stdcall;
...
exports  AES_OMAC_UpdateXL      name 'AES_OMAC_UpdateXL';
...
exports  AES_CMAC_UpdateXL      name 'AES_CMAC_UpdateXL';
